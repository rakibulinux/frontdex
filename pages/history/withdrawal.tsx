...
function History(): JSX.Element {
    ...
    useEffect(() => {
        ...
        ;(async () => {
            ...
            const withdrawn = await custody.getWithdrawn(null, account)

            // map withdrawn to Transaction
            const transactions = await Promise.all(
                withdrawn.map(async (d) => {
    ...
    return (
        <>
            <Head>
                <title>{appTitle('Withdrawal History')}</title>
            </Head>
            {!active ? (
                                                        ...
                                                        (transaction) => {
                                                            return (
                                                                ...
                                                                >
                                                                    ...
                                                                    <td className="w-full px-6 py-2 text-right whitespace-nowrap overflow-ellipsis text-sm text-gray-500">
                                                                        {transaction.rid
                                                                            ? shortenHex(
                                                                                  transaction.rid,
                                                                              )
